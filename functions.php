<?php
/**
 * DacliWeb functions related to defining constants, adding files and WordPress core functionality.
 *
...
if ( ! function_exists( 'spacious_setup' ) ) :
	function spacious_setup() {
		...
		register_nav_menus(
			array(
                'tech_menu' => 'Tecnologías de Portada',
			...
			'widgets'     => array(
				...
				'spacious_business_page_top_section_sidebar' => array(
					...
					'call_to_action'        => array(
						...
						array(
							...
							'button_url'      => 'https://ale8bits.com/themes/spacious/',
						),
					),
				),
				...
				'spacious_footer_sidebar_three' => array(
					'text_custom_menu' => array(
						'text',
						array(
							'title' => esc_html__( 'DacliWeb Important Links', 'spacious' ),
							'text'  => '<ul>
											<li><a href="https://ale8bits.com/themes/spacious/">' . esc_html__( 'Theme Info', 'spacious' ) . '</a></li>
											<li><a href="https://ale8bitsdemos.com/spacious/">' . esc_html__( 'View Demo', 'spacious' ) . '</a></li>
											<li><a href="https://www.youtube.com/watch?v=rhiybsv3vUU">' . esc_html__( 'Import Demo', 'spacious' ) . '</a></li>
											<li><a href="https://docs.ale8bits.com/spacious/">' . esc_html__( 'Documentation', 'spacious' ) . '</a></li>
...
/**
 * Assign the DacliWeb version to a variable.
 */
...
/**
 * Load the DacliWeb Toolkit file.
 */
if ( class_exists( 'DacliWeb_Toolkit' ) ) {
