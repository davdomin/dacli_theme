...
DacliWeb WordPress Theme, Copyright 2014 ale8bits
DacliWeb is distributed under the terms of the GNU GPL
...
= Theme Instruction =
Get theme instruction at https://docs.ale8bits.com/spacious/

= Free Support =
Get free support at https://ale8bits.com/contact/
...
== TRANSLATIONS ==
If you've translated this theme into your language, feel free to send the translation over to ale8bits@gmail.com
...
* Added - New Demo (DacliWeb Farm)- Use this DacliWeb demo to create your farm or agricultural website.
...
* Added - New Demo (DacliWeb Band)- Use this DacliWeb demo to create a music band website for your music enthusiasts.
...
* Added - New Demo (DacliWeb Vet)- Use this DacliWeb demo to create your pet-friendly vet website.
* Added - New Demo (DacliWeb Event )- Use this DacliWeb demo if you want to create an event website.
...
* Added   - New Demo (DacliWeb Gym)- Start creating your fitness website with this DacliWeb Gym demo.
* Added   - New Demo (DacliWeb Interior)- Use this DacliWeb demo to start building your online interior designing services.
* Added   - New Demo (DacliWeb Company)- Use this DacliWeb demo to build and grow your company website.
* Fix     - Design issues of widgets when used in elementor.

= Version 1.6.7 - 2019-10-16 =
* Added   - New Demo (DacliWeb Food)- Use this DacliWeb demo to create a fantastic website for your food enthusiasts.
...
* Added   - New Demo (DacliWeb Freelancer) - Use this DacliWeb demo to create your amazing website.
* Added   - New Demo (DacliWeb Car Repair) -Use this demo to create the perfect website for your car repair shop.
...
* Tweak - Added message to make user aware while installing and activating the ale8bits demo importer plugin.

= Version 1.6.3 - 2019-05-23 =
* Added   - New Demo (DacliWeb Store) - If you want to create an online store for your website, use this DacliWeb demo.
...
* Added   - New Demo (DacliWeb Medical) - Aid your patient's health with the help of this DacliWeb Medical demo.
...
* Tweak - Added site library and demo import process in About DacliWeb page.
...
* Tweaks - Add TGMPA to recommend ale8bits Demo Importer plugin
