...
(
	function ( $ ) {
		 ...
		 *
		 * @class DacliWeb_Customizer_FrameWork
		 */
		var DacliWeb_Customizer_FrameWork = {
			...
			checkControlVisibility : function ( control, id ) {
				...
				if ( ! _.isUndefined( control ) ) {
					...
					if ( 'undefined' != typeof DacliWebCustomizerControlsToggle[id] ) {
						var check            = false,
						    dependency_param = DacliWebCustomizerControlsToggle[id],
			...
			checkDependency : function ( conditions, values, compare_operator ) {
				...
				if ( _.isString( testValue ) ) {
					...
					if ( ! _.isUndefined( DacliWebCustomizerControlsToggle[testValue] ) ) {
						var conditions = ! _.isUndefined( DacliWebCustomizerControlsToggle[testValue]['conditions'] ) ? DacliWebCustomizerControlsToggle[testValue]['conditions'] : DacliWebCustomizerControlsToggle[testValue];
						var operator   = ! _.isUndefined( DacliWebCustomizerControlsToggle[testValue]['operator'] ) ? DacliWebCustomizerControlsToggle[testValue]['operator'] : 'AND';
					...
					$.each(
						...
						function ( index, val ) {
							...
							if ( 'undefined' !== typeof DacliWebCustomizerControlsToggle[cond_key] ) {
								var conditions = ! _.isUndefined( DacliWebCustomizerControlsToggle[cond_key]['conditions'] ) ? DacliWebCustomizerControlsToggle[cond_key]['conditions'] : DacliWebCustomizerControlsToggle[cond_key];
								var operator   = ! _.isUndefined( DacliWebCustomizerControlsToggle[cond_key]['operator'] ) ? DacliWebCustomizerControlsToggle[cond_key]['operator'] : 'AND';
			...
			hasDependentControls : function ( control_id ) {
				...
				$.each(
					DacliWebCustomizerControlsToggle,
					function ( index, val ) {
		...
		$(
			function () {
				DacliWeb_Customizer_FrameWork.init();
			}
		);
