...
(
	function ( $ ) {
		...
		DacliWebCustomizer = {
			 ...
			 */
			init : function () {
				DacliWebCustomizer._initToggles();
			},
			...
			_initToggles : function () {
				...
				DacliWebControlTrigger.triggerHook( 'spacious-toggle-control', api );

				// Loop through each setting.
				$.each(
					DacliWebCustomizerToggles,
