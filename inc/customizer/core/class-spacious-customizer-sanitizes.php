<?php
/**
 * DacliWeb customizer class for theme customize sanitizes.
 *
 * Class DacliWeb_Customizer_FrameWork_Sanitizes
 *
 * @package    ale8bits
 * @subpackage DacliWeb
...
/**
 * DacliWeb customizer class for theme customize callbacks.
 *
 * Class DacliWeb_Customizer_FrameWork_Sanitizes
 */
class DacliWeb_Customizer_FrameWork_Sanitizes {
	...
	public static function sanitize_typography( $typography_args, $setting ) {
		...
		if ( isset( $typography_args['subsets'] ) ) {
			...
			$subsets        = DacliWeb_Fonts::get_google_font_subsets();
