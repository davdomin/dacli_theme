 ...
 *
 * Class DacliWeb_Typography_Control
 *
 * @package    ale8bits
 * @subpackage DacliWeb
 ...
 * Class DacliWeb_Typography_Control
 */
class DacliWeb_Typography_Control extends DacliWeb_Customize_Base_Additional_Control {
	...
	public function enqueue() {
		...
		$google_font_subsets = DacliWeb_Fonts::get_google_font_subsets();
		...
		wp_localize_script(
			...
			'DacliWebCustomizerControlTypography',
			$localize_scripts
		);
		...
		wp_localize_script(
			'spacious-customize-controls',
			'DacliWebCustomizerControlTypographySubsets',
			$google_font_subsets
		);
	...
	protected function format_variants_array( $variants ) {
		...
		$font_variants  = DacliWeb_Fonts::get_font_variants();
	...
	public function get_system_fonts() {
		...
		$standard_fonts       = DacliWeb_Fonts::get_system_fonts();
	...
	public function get_google_fonts() {
		...
		$google_fonts          = DacliWeb_Fonts::get_google_fonts();
		$font_variants         = DacliWeb_Fonts::get_font_variants();
		$foogle_fonts__subsets = DacliWeb_Fonts::get_google_font_subsets();
	...
	public function get_custom_fonts() {
		...
		$custom_fonts       = DacliWeb_Fonts::get_custom_fonts();
	...
	public function to_json() {
		...
		$this->json['languages']   = DacliWeb_Fonts::get_google_font_subsets();
