 ...
 *
 * Class DacliWeb_Background_Control
 */
class DacliWeb_Background_Control extends DacliWeb_Customize_Base_Additional_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'DacliWebCustomizerControlBackground',
			array(
