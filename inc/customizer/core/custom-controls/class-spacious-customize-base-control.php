<?php
/**
 * DacliWeb customizer base control class for theme customize options.
 *
 * Class DacliWeb_Customize_Base_Control
 *
 * @package    ale8bits
 * @subpackage DacliWeb
...
/**
 * DacliWeb customizer base control class.
 *
 * Class DacliWeb_Customize_Base_Control
 */
class DacliWeb_Customize_Base_Control {
...
return new DacliWeb_Customize_Base_Control();
