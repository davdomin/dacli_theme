 ...
 *
 * Class DacliWeb_Fontawesome_Control
 *
 * @package    ale8bits
 * @subpackage DacliWeb
 ...
 * Class DacliWeb_Fontawesome_Control
 */
class DacliWeb_Fontawesome_Control extends DacliWeb_Customize_Base_Additional_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'DacliWebCustomizerControlFontawesome' . $this->id,
			$fontawesome_array
		);
	}
