 ...
 *
 * Class DacliWeb_Customize_Register_Section_Panels
 *
 * @package    ale8bits
 * @subpackage spacious
 ...
 * Class DacliWeb_Customize_Register_Section_Panels
 */
class DacliWeb_Customize_Register_Section_Panels extends DacliWeb_Customize_Base_Option {
	...
	public function register_options( $options, $wp_customize ) {
		...
		$configs = array(
			...
			array(
				...
				'url'              => 'https://ale8bits.com/spacious-pricing/?utm_source=spacious-customizer&utm_medium=view-pro-link&utm_campaign=spacious-pricing',
				'priority'         => 1,
				'section_callback' => 'DacliWeb_Upsell_Section',
			),
			...
			array(
				...
				'type'             => 'section',
				'priority'         => 80,
				'section_callback' => 'DacliWeb_WP_Customize_Separator',
			),
...
return new DacliWeb_Customize_Register_Section_Panels();
