<?php
/**
 * DacliWeb functions and definitions
 *
...
if ( ! function_exists( 'spacious_footer_copyright' ) ) :
	function spacious_footer_copyright() {
		...
		$tg_link = '<a href="' . esc_url( 'https://ale8bits.com/themes/spacious' ) . '" target="_blank" title="' . esc_attr__( 'DacliWeb', 'spacious' ) . '" rel="nofollow"><span>' . __( 'DacliWeb', 'spacious' ) . '</span></a>';

		$default_footer_value = sprintf( __( 'Copyright &copy; %1$s %2$s.', 'spacious' ), date( 'Y' ), $site_link ) . ' ' .__('All rights reserved.', 'spacious' ). sprintf( __( ' Theme %1$s', 'spacious' ), $tg_link ) . ' ' . sprintf( __( 'by ale8bits. Powered by: %2$s.', 'spacious' ), 'DacliWeb', $wp_link );
