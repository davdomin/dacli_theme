<?php
/**
 * Adds new widgets and compatibility for the Elementor plugin in DacliWeb theme.
 *
 * @package    ale8bits
 * @subpackage DacliWeb
 * @since      DacliWeb 1.5
...
class DacliWeb_Elementor_Addons {
	...
	public static function get_instance() {
		...
		if ( null == self::$instance ) {
			self::$instance = new DacliWeb_Elementor_Addons();
		}
