...
class DacliWeb_TDI_Notice {
	...
	public function admin_notices() {
		$plugin = 'ale8bits-demo-importer/ale8bits-demo-importer.php';
	...
	public function tdi_notice() {
		...
		<div class="error updated tdi-notice" style="position:relative;">
			...
			$msg = sprintf(
				...
				'<strong>' . esc_html__( 'ale8bits Demo Importer', 'spacious' ) . '</strong>',
				sprintf(
