...
class DacliWeb_Upgrade_Notice extends DacliWeb_Notice {
	...
	public function notice_markup() {
		...
		<div class="notice notice-success spacious-notice">
			...
			<div class="links">
				...
				<a href="https://ale8bits.com/contact/?utm_source=spacious-dashboard-message&utm_medium=button-link&utm_campaign=pre-sales" class="button button-secondary" target="_blank">
