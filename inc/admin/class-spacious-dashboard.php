	...
	public function option_page() {
		...
		<div class="spacious-header">
			<h1>
				...
				echo sprintf( esc_html__( 'DacliWeb %s', 'spacious' ), $theme->Version );
				?>
			</h1>
		</div>
				...
				<div class="welcome-panel-column-container">
					<div class="welcome-panel-column">
						...
						<a class="button button-primary button-hero"
						   href="<?php echo esc_url( 'https://docs.ale8bits.com/spacious/#section-1' ); ?>"
					...
					<div class="welcome-panel-column">
						...
						<ul>
							<li><?php printf( '<a target="_blank" href="%s" class="welcome-icon dashicons-media-text">' . esc_html__( 'Documentation', 'spacious' ) . '</a>', esc_url( 'https://docs.ale8bits.com/spacious' ) ); ?></li>
							<li><?php printf( '<a target="_blank" href="%s" class="welcome-icon dashicons-layout">' . esc_html__( 'Starter Demos', 'spacious' ) . '</a>', esc_url( 'https://ale8bitsdemos.com/spacious-demos/' ) ); ?></li>
							<li><?php printf( '<a target="_blank" href="%s" class="welcome-icon dashicons-migrate">' . esc_html__( 'Premium Version', 'spacious' ) . '</a>', esc_url( 'https://ale8bits.com/themes/spacious' ) ); ?></li>
						</ul>
					</div>
