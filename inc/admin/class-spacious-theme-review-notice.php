<?php
/**
 * DacliWeb Theme Review Notice Class.
 *
 * @author  ale8bits
 * @package DacliWeb
 * @since   1.6.3
 ...
 *
 * Class DacliWeb_Theme_Review_Notice
 */
class DacliWeb_Theme_Review_Notice {
	 ...
	 *
	 * DacliWeb_Theme_Review_Notice constructor.
	 */
		...
		<div class="notice notice-success spacious-notice theme-review-notice" style="position:relative;">
			<div class="spacious-message__content">
				<div class="spacious-message__image">
					<img class="spacious-logo--png" src="<?php echo esc_url( get_template_directory_uri() . '/inc/admin/images/spacious-logo-square.png' ); ?>" alt="<?php esc_attr_e( 'DacliWeb', 'spacious' ); ?>" />
				</div>
...
new DacliWeb_Theme_Review_Notice();
