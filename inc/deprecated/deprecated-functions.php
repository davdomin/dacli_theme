<?php
/**
 * Deprecated functions for DacliWeb theme.
 *
 * @package    ale8bits
 * @subpackage DacliWeb
 * @since      DacliWeb 2.4.5
 */
...
if ( ! function_exists( 'spacious_radio_sanitize' ) ) :
	...
	function spacious_radio_sanitize( $input, $setting ) {
		...
		_deprecated_function( __FUNCTION__, '2.4.5', 'DacliWeb_Customizer_Sanitizes::sanitize_radio_select( $input, $setting )' );

		return DacliWeb_Customizer_Sanitizes::sanitize_radio_select( $input, $setting );
...
if ( ! function_exists( 'spacious_checkbox_sanitize' ) ) :
	...
	function spacious_checkbox_sanitize( $input ) {
		...
		_deprecated_function( __FUNCTION__, '2.4.5', 'DacliWeb_Customizer_Sanitizes::sanitize_checkbox( $input )' );

		return DacliWeb_Customizer_Sanitizes::sanitize_checkbox( $input );
...
if ( ! function_exists( 'spacious_editor_sanitize' ) ) :
	...
	function spacious_editor_sanitize( $input ) {
		...
		_deprecated_function( __FUNCTION__, '2.4.5', 'DacliWeb_Customizer_Sanitizes::sanitize_html( $input )' );

		return DacliWeb_Customizer_Sanitizes::sanitize_html( $input );
...
if ( ! function_exists( 'spacious_color_option_hex_sanitize' ) ) :
	...
	function spacious_color_option_hex_sanitize( $color ) {
		...
		_deprecated_function( __FUNCTION__, '2.4.5', 'DacliWeb_Customizer_Sanitizes::sanitize_hex_color( $color )' );

		return DacliWeb_Customizer_Sanitizes::sanitize_hex_color( $color );
...
if ( ! function_exists( 'spacious_customize_partial_blogname' ) ) :
	...
	function spacious_customize_partial_blogname() {
		...
		_deprecated_function( __FUNCTION__, '2.4.5', 'DacliWeb_Customizer_Partials::render_customize_partial_blogname()' );

		DacliWeb_Customizer_Partials::render_customize_partial_blogname();
...
if ( ! function_exists( 'spacious_customize_partial_blogdescription' ) ) :
	...
	function spacious_customize_partial_blogdescription() {
		...
		_deprecated_function( __FUNCTION__, '2.4.5', 'DacliWeb_Customizer_Partials::render_customize_partial_blogdescription()' );

		DacliWeb_Customizer_Partials::render_customize_partial_blogdescription();
...
if ( ! function_exists( 'spacious_options' ) ) :
	...
	/**
	 *  Depreciate DacliWeb theme options function.
	 */
